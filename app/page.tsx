    ...
    <>
      ...
      <section className="relative flex min-h-screen items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-4xl px-6 text-center">
          ...
          <p className="mx-auto mb-10 max-w-[65ch] text-base leading-relaxed text-text-secondary md:text-lg">
          ...
          <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
            ...
            <a
              href="/pricelist"
              className="
                inline-flex items-center gap-2 rounded-md bg-primary 
      ...
      <section id="scroll-section" className="relative min-h-screen bg-surface border-t border-border">
        <div className="mx-auto max-w-7xl px-6 py-32">
          <div className="text-center">
            {/* Removed upperkick tracking eyebrow and text gradient */}
